...
API_ID = int(environ.get('API_ID', '24814351'))
API_HASH = environ.get('API_HASH', 'ea95433701219fff7113e325979b7707')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8122442461').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002739301908'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-4913684171').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002708017052') # give your force subscribe channel id here else leave it blank
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002882107492').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://wwwfarookcpy:tqQZV2VMCRFxBh9e@cluster0.vxvd9zq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+BN500QqPgDRlZWNk')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+yCBlvcWwObI0NDk0')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@Farookhannah') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@Farookhannah')
